               ...
               <div className="section2">
                  ...
                  >
                     ...
                     <div className="upload_img_container">
                        <div id="dotted_border">
                           <div className="pint_mock_icon_container">
                              <img src="./images/arrow-up.png" alt="upload_img" className="pint_mock_icon" />
                           </div>
                           <div>Click to upload</div>
                           <div>Recomendation: Use hight-quality .jpg less than 20MB</div>
                  ...
                  <div className="modals_pin"
                     ...
                     <div className="pin_image">
                        <img onLoad={chec_size} src={pinDetails.img_blob} alt="pin_image" />
                     </div>
                  </div>
               </div>
